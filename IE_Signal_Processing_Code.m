...
clear; clc; close all;
fprintf('Starting Impact-Echo Delamination Estimation (Sengupta et al. 2021)...\n');

%% ==================== USER CONFIGURATION ====================

% ⚙️ Adjust these if your data differs
input_file = 'IE_2013.xlsx';   % Your IE data file (see format above)
% input_IE_data.xlsx
fs = 1000e3;                         % Sampling frequency (Hz) — adjust if needed
...
pct_poor = N_poor / totalN * 100;  % ← THIS IS YOUR DELAMINATION ESTIMATE
